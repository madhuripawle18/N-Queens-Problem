...
class Hill_Climbing:
    ...
    def HC_initial(self):
        ...
        print("Average Number of random restarts used with sideways move", Hill_Climbing.total_r_count/Hill_Climbing.input_count)
        print("Average number of steps required with sideways ", Hill_Climbing.t_count/Hill_Climbing.input_count)
    ...
    def selection(self, heuristic_board):
        ...
        for i in range(0, Hill_Climbing.col):
            ...
            elif min_value == temp:  # Appending the locations of all heuristics equal to global maxima
                x = i
                y = heuristic_board[i].index(min_value)
                min_list.append([min_value, x, y])
        ...
        if temp < Hill_Climbing.global_max:
            ...
            if(Hill_Climbing.side_count==1):
                Hill_Climbing.w_count = Hill_Climbing.w_count + 1

        elif Hill_Climbing.side_count==101:
            Hill_Climbing.r_count = Hill_Climbing.r_count+1

            # print (Hill_Climbing.r_count)
            Hill_Climbing.status = 0
